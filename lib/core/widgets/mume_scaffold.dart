...
class MumeScaffold extends StatelessWidget {
  const MumeScaffold({
    super.key,
    this.kind = AppBarKind.logo,
    this.title,
    required this.body,
    this.onMore,
    this.moreIcon, // ✅ NEW: Allows customizing the action icon
    this.bottom,
              ...
              child: Row(
                children: [
                  ...
                  if (onMore != null) ...[
                    ...
                    // ✅ Use the custom moreIcon if provided, otherwise default to moreCircle
                    IconBtn(icon: moreIcon ?? AppIcons.moreCircle, onTap: onMore),
                  ],
                ],
              ),
            ),
